              ...
              <div className="w-full md:w-auto p-6 bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-white text-black font-bold px-6 py-3 rounded-xl hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
            ...
            <section>
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 text-lg leading-relaxed">
                  Experience the ultimate {game.category} adventure in{" "}
                  {game.title}. Immerse yourself in a stunning world filled with
                  detailed environments, complex characters, and engaging
                  gameplay mechanics that will keep you hooked for hours.
                </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Get your key immediately after payment
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
